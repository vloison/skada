...
PackedDatasetType = Union[Bunch, Tuple[ArrayLike, ArrayLike, ArrayLike]]
...
class DomainAwareDataset:
    ...
    def pack(
        ...
        if torch is not None and len(Xs) > 0 and isinstance(Xs[0], torch.Tensor):
            is_data_tensor = True
        else:
